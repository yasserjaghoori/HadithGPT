    ...
    <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-4">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="relative">
          <div className="relative rounded-3xl bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 focus-within:border-primary-500 dark:focus-within:border-primary-500 transition-all">
            <textarea
              ref={textareaRef}
              value={input}
              ...
              disabled={isLoading}
              className="w-full resize-none rounded-3xl bg-transparent px-5 py-4 pr-14 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed max-h-32 overflow-y-auto"
              rows={1}
            />
            <button
              type="submit"
